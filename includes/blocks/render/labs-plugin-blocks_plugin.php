...
<div <?php echo wp_kses_data( get_block_wrapper_attributes() ); ?>>
	<div class="wp-block-labs-plugin-blocks-plugin--container">
		<?php if ( ! empty( $attributes['title'] ) ) : ?>
		<h6 class="wp-block-labs-plugin-blocks-plugin--title"><?php echo esc_html( $attributes['title'] ); ?></h6>
		<?php endif; ?>

		<?php if ( ! empty( $attributes['excerpt'] ) ) : ?>
		<blockquote class="wp-block-labs-plugin-blocks-plugin--excerpt"><?php echo wp_kses_post( $attributes['excerpt'] ); ?></blockquote>
		<?php endif; ?>
