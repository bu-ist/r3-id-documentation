...
/***/ "./src/blocks/sandbox-image/block.json":
/*!*********************************************!*\
  !*** ./src/blocks/sandbox-image/block.json ***!
  \*********************************************/
/***/ (function(module) {
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/wp/5.8/block.json","apiVersion":2,"name":"r3-id-documentation/image","version":"0.1.0","title":"<Image> Component - Playground","category":"r3-id-documentation-pattern-category","icon":"format-image","description":"This block is used to explore and adjust the parameters sent to the <Image> Component.","example":{},"attributes":{"canEditImage":{"type":"boolean"},"debug":{"type":"boolean"},"tag":{"type":"string","enum":["img","picture","figure"]},"size":{"type":"string"},"altSource":{"type":"string"},"mediaId":{"type":"string"},"className":{"type":"string"},"canEditFocalPoint":{"type":"boolean"},"focalPoint":{"type":"string"},"label":{"type":"string"},"instructions":{"type":"string"},"labels":{"type":"array"}},"supports":{"html":false},"textdomain":"r3-id-documentation","editorScript":"file:./index.js","editorStyle":"file:./index.css"}');

/***/ }),

/***/ "./src/blocks/sandbox-image/edit.js":
/*!******************************************!*\
  !*** ./src/blocks/sandbox-image/edit.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/components */ "@wordpress/components");
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _imports_index_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./imports/index.mjs */ "./src/blocks/sandbox-image/imports/index.mjs");
/**
 * Image Demo
 *
...
function Edit(props) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)(), /*#__PURE__*/React.createElement(_imports_index_mjs__WEBPACK_IMPORTED_MODULE_3__.Image
  // Component setup
  , {
    ...
    focalPoint: StringToObjectConverter(attributes.focalPoint // FAILS
    )
    //
    ...
    labelsMediaPlaceholder: StringToObjectConverter(attributes.labelsMediaPlaceholder // FAILS
    )
  ...
  }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelRow, null, "Use these controls to adjust the parameters sent to the Component:"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelRow, null, "Component setup"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelRow, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
    label: "canEditImage",
  ...
  })), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelRow, null, "Placeholder overrrides"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelRow, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
    label: "label",
  ...
  })), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelRow, null, "MediaPlaceholder overrrides"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelRow, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
    ...
    onChange: labelsMediaPlaceholder => setAttributes({
      labelsMediaPlaceholder
    })
  })), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelRow, null, "FocalPointPicker overrrides"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelRow, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
    label: "canEditFocalPoint",
    help: "Can the user change the image?",
    checked: attributes.canEditFocalPoint,
    onChange: canEditFocalPoint => setAttributes({
      canEditFocalPoint
    })
  })), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelRow, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
    label: "focalPoint",
...
/***/ "./src/blocks/sandbox-image/imports/index.mjs":
/*!****************************************************!*\
  !*** ./src/blocks/sandbox-image/imports/index.mjs ***!
  \****************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _bostonuniversity_block_imports__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @bostonuniversity/block-imports */ "./node_modules/@bostonuniversity/block-imports/index.js");
function _extends() {
...
const Image = props => {
  ...
  //  */
  const [currentFocalPoint, setFocalPoint] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(focalPoint);
  // const [ currentMedia, setMedia ] = useState( media );
  const [currentMediaId, setMediaId] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(mediaId);
  ...
  if (isResolvingMedia) {
    ...
    return /*#__PURE__*/React.createElement(_bostonuniversity_block_imports__WEBPACK_IMPORTED_MODULE_5__.LoadingSpinner
    // Required Props - none
   ...
   * @todo this doesn't seem to update/useState?
   */
  const imgObj = (0,_bostonuniversity_block_imports__WEBPACK_IMPORTED_MODULE_5__.getImageData)(mediaObj, size);
  if (debug) {
   ...
   */
  if (!hasImage && !canEditImage) {
    return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Placeholder
    // Required Props - none
   ...
   */
  if (!hasImage) {
    return /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.MediaPlaceholder
    // Required Props
    , {
  ...
  if (tag === 'picture') {
    const srcset = {
      sources: [{
        srcset: (0,_bostonuniversity_block_imports__WEBPACK_IMPORTED_MODULE_5__.getImageData)(mediaObj, 'medium').src,
        media: '(min-width: 600px)',
        type: imgObj.mime_type
      }, {
        srcset: (0,_bostonuniversity_block_imports__WEBPACK_IMPORTED_MODULE_5__.getImageData)(mediaObj, 'large').src,
        media: '(min-width: 300px)'
      }]
    };
    for (let i = 0; i < srcset.sources.length; i++) {
      const source = srcset.sources[i];
      sources.push(/*#__PURE__*/React.createElement("source", {
   ...
   */
  return /*#__PURE__*/React.createElement("div", null, (canEditImage || canEditFocalPoint) && /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Image Settings')
  }, canEditImage && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h2", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Replace Image')), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelRow, null, canEditImage && /*#__PURE__*/
  // https://github.com/WordPress/gutenberg/blob/HEAD/packages/block-editor/src/components/media-upload/README.md
  React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.MediaUploadCheck, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.MediaUpload, {
    onSelect: media => setMediaId(media.id),
    ...
    render: ({
      ...
      icon: "edit",
      isLarge: true
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Edit Media'))
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Remove Media'))))), canEditFocalPoint && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelRow, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.FocalPointPicker, {
  ...
  })))), tag === 'picture' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h3", null, "picture"), /*#__PURE__*/React.createElement("picture", _extends({
    className: getClasses(className)
  }, rest), sources, /*#__PURE__*/React.createElement("img", {
    src: imgObj.src,
    alt: altText
  }))), tag === 'figure' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h3", null, "figure"), /*#__PURE__*/React.createElement("figure", _extends({
    className: getClasses(className)
  }, rest), /*#__PURE__*/React.createElement("img", {
    src: imgObj.src,
    alt: altText
  }), /*#__PURE__*/React.createElement("figcaption", null, altText))), tag === 'img' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h3", null, "img"), /*#__PURE__*/React.createElement("img", _extends({
    className: getClasses(className),
    src: imgObj.src,
    alt: altText
  }, rest))));
...
"use strict";
/*!*******************************************!*\
  !*** ./src/blocks/sandbox-image/index.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edit */ "./src/blocks/sandbox-image/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block.json */ "./src/blocks/sandbox-image/block.json");
/**
