...
/* harmony import */ var _imports_index_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./imports/index.mjs */ "./src/blocks/sandbox-image/imports/index.mjs");
/**
 * Image Demo
 *
...
function Edit(props) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)(), /*#__PURE__*/React.createElement(_imports_index_mjs__WEBPACK_IMPORTED_MODULE_5__.Image
  // Component setup
  , {
    ...
    labelsPlaceholder: StringToObjectConverter(attributes.labelsPlaceholder)
    //
    ...
    onChange: labelsPlaceholder => setAttributes({
      labelsPlaceholder
    })
  ...
  })), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelRow, null, "FocalPointPicker overrrides"), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelRow, null, "The actual component Setup..."), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelRow, null, "InspectorControls overrecids"))));
}
...
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/components */ "@wordpress/components");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _bostonuniversity_block_imports__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @bostonuniversity/block-imports */ "./node_modules/@bostonuniversity/block-imports/index.js");
function _extends() {
...
const Image = props => {
  const {
    ...
    allowedTypes = ['audio'],
    accept = 'audio/*',
    // @todo we can't just implode allowedTypes to get the sting because the format is different
    //
    //
    //
    //
    ...
    // callbacks https://github.com/bu-ist/r-graduate-education/pull/257/files#diff-7b74753b11d6f004c1d077fd96f098fa14cafc45a57570f95e38bd1b9dffe47d
  ...
  const {
    ...
    isResolvingMedia,
    hasResolvedMedia
  } = (0,_bostonuniversity_block_imports__WEBPACK_IMPORTED_MODULE_4__.useMedia)(mediaId);
   ...
   */
  if (isResolvingMedia) {
    return /*#__PURE__*/React.createElement(_bostonuniversity_block_imports__WEBPACK_IMPORTED_MODULE_4__.LoadingSpinner
    // Required Props - none
  ...
  return /*#__PURE__*/React.createElement("div", null, (canOverrideImage || onRemove || displayFocalPointPicker) && /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    render: ({
      ...
      onClick: open,
      icon: "edit",
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Edit Media'),
      isDefault: true,
      isLarge: true
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Edit'))
  })), onRemove && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
    className: "bu-components-image-media-remove-button",
    onClick: onRemove,
    label: 'Remove Media',
    isLink: true
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Remove Media'))))), displayFocalPointPicker && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelRow, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.FocalPointPicker, {
