<?php
/**
 * Child theme level override of R3 template used to render a static page. This removes the sidebar. No other changes have been made.
 *
...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'content-area' ); ?>>
	...
	<?php
			wp_link_pages(
				array(
					'before' => sprintf( '<div class="page-link">%s', esc_html__( 'Pages:', 'r3-id-documentation' ) ),
					'after'  => '</div>',
				)
			);
	?>
	...
	<?php edit_post_link( __( 'Edit Page', 'r3-id-documentation' ), '<span class="edit-link">', '</span><span class="post-edit-hint"></span>' ); ?>
