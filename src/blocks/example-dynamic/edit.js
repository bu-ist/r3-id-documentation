...
export default function Edit({attributes, setAttributes}) {
	...
	return (
		 <div { ...useBlockProps() }>
			<div className="wp-block-bu-block-starter-dynamic--container">
				<RichText
					className="wp-block-bu-block-starter-dynamic--title"
					placeholder={ __('Callout Title', 'bu-block-starter')}
					tagName="h2"
				...
				/>
				<RichText
					placeholder={ __('Excerpt', 'bu-block-starter')}
					tagName="p"
					classname="wp-block-bu-block-starter-dynamic--excerpt"
