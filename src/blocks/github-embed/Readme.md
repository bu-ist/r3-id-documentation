...
- enter the GitHub URL of the file for the code explorer (eg: <https://github.com/bu-ist/labs-plugin-blocks/blob/timk/codeblock/src/blocks/github-embed/Readme.md>)
